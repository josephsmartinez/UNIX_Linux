...
$server = array(
    'base' => '',
    'cups' => 'https://www.linux.org/',
    'scan' => 'https://www.cis.fiu.edu/'
);
$values = array();
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">System Information Dashboard</span>
      ...
      <div class="mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        <nav class="mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="<?php echo $server['cups']; ?>">
            <i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">computer</i>About Linux</a>
          <a class="mdl-navigation__link" href="<?php echo $server['scan']; ?>">
            <i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">school</i>FIU CIS</a>
          <div class="mdl-layout-spacer"></div>
