...
- [Commands](#commands)
- [Network Devices]()
- [Locating Network Setting and Interfaces](#locating-network-setting-and-interfaces)
...
Predictable Network Interface Device Names. There are five types of names that can be given:
